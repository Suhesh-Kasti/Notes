...
![[images/logo_hacking_wordpress.png]]
...
![[images/plugin-deactivated3.png]]
...
| [!] Title: Mail Masta 1.0 - Multiple [[vuln--sql-injection]]
...
We can use the Metasploit Framework (MSF) to obtain a [[vuln--reverse-shell-bind-shell]] on the target automatically. This requires valid credentials for an account that has sufficient rights to create files on the webserver.
