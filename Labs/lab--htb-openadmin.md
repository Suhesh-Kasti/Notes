...
Foothold
----
Let's get a proper [[vuln--reverse-shell-bind-shell]] because currently this sends an HTTP request every time we want to do something which isn't great for a command like "su -" we don't have a full TTY.
